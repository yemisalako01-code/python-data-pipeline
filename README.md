...
Production-grade implementation of python data pipeline.

## 🔍 TL;DR
> Robust implementation of python data pipeline with best practices.
...
### Local Setup
```bash
git clone https://github.com/yemisalako01-code/python-data-pipeline.git
